...
//   var cls = getVal('regClass'), dept = getVal('regDepartment'), subj = getVal('regSubject');
...
//   if (role === 'teacher' && !subj) return showError(errEl, 'Please select your subject.');
...
//   try {
//     var payload = { role, firstName: fn, lastName: ln, username: un, email: em, password: pw, gender: gender };
//     if (role === 'student') { payload.class = cls; payload.department = dept; }
//     if (role === 'teacher') { payload.subject = subj; payload.phone = phone; }
...
//       return e.status === 'approved' && (e.targetClass === myClass || e.targetClass === 'All');
//     });
...
//   try {
//     var students = await Api.get('/students');
//     _tsStudents = students.filter(function (s) { return s.class === cls; });
